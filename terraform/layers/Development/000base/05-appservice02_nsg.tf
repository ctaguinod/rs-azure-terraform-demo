resource "azurerm_network_security_group" "appservice02_nsg" {
  name                = "${var.appservice02_subnet_name}-NSG"
  ...
  security_rule {
    ...
    destination_address_prefix = var.appservice02_subnet_prefix
  ...
  security_rule {
    ...
    protocol                   = "*"
    source_port_range          = "*"
    source_address_prefix      = var.appservice02_subnet_prefix
    destination_address_prefix = var.appservice02_subnet_prefix
...
output "appservice02_nsg_nsg_id" {
  value = "${azurerm_network_security_group.appservice02_nsg.id}"
}
