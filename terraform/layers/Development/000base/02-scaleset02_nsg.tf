resource "azurerm_network_security_group" "scaleset02_nsg" {
  name                = "${var.scaleset02_subnet_name}-NSG"
  ...
  security_rule {
    ...
    destination_address_prefix = var.scaleset02_subnet_prefix
  ...
  security_rule {
    ...
    protocol                   = "*"
    source_port_range          = "*"
    source_address_prefix      = var.scaleset02_subnet_prefix
    destination_address_prefix = var.scaleset02_subnet_prefix
...
output "scaleset02_nsg_nsg_id" {
  value = "${azurerm_network_security_group.scaleset02_nsg.id}"
}
