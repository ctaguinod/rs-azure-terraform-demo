resource "azurerm_network_security_group" "appservice01_nsg" {
  name                = "${var.appservice01_subnet_name}-NSG"
  ...
  security_rule {
    ...
    destination_address_prefix = var.appservice01_subnet_prefix
  ...
  security_rule {
    ...
    protocol                   = "*"
    source_port_range          = "*"
    source_address_prefix      = var.appservice01_subnet_prefix
    destination_address_prefix = var.appservice01_subnet_prefix
...
output "appservice01_nsg_nsg_id" {
  value = "${azurerm_network_security_group.appservice01_nsg.id}"
}
